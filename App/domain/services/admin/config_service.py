...
class AtelierService:
    ...
    def create(nom: str) -> int:
        ...
        log_hist_async(action="CREATION_ATELIER", table_name="atelier", record_id=new_id, description=f"Atelier créé : {nom}")
        return new_id
    ...
    def update(atelier_id: int, nom: str) -> None:
        ...
        log_hist_async(action="MODIFICATION_ATELIER", table_name="atelier", record_id=atelier_id, description=f"Atelier #{atelier_id} modifié : {nom}")
    ...
    def delete(atelier_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_ATELIER", table_name="atelier", record_id=atelier_id, description=f"Atelier #{atelier_id} supprimé")
...
class ServicesRHService:
    ...
    def create(nom_service: str, description: str = None) -> int:
        ...
        log_hist_async(action="CREATION_SERVICE", table_name="services", record_id=new_id, description=f"Service créé : {nom_service}")
        return new_id
    ...
    def delete(service_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_SERVICE", table_name="services", record_id=service_id, description=f"Service #{service_id} supprimé")
...
class TypeAbsenceService:
    ...
    def create(code: str, libelle: str, decompte_solde: bool = True,
        ...
        log_hist_async(action="CREATION_TYPE_ABSENCE", table_name="type_absence", record_id=new_id, description=f"Type absence créé : {code} - {libelle}")
        return new_id
    ...
    def update(type_id: int, code: str, libelle: str,
        ...
        log_hist_async(action="MODIFICATION_TYPE_ABSENCE", table_name="type_absence", record_id=type_id, description=f"Type absence #{type_id} modifié : {code}")
    ...
    def delete(type_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_TYPE_ABSENCE", table_name="type_absence", record_id=type_id, description=f"Type absence #{type_id} supprimé")
...
class JoursFeriesService:
    ...
    def create(date_ferie: str, libelle: str, fixe: bool = True) -> int:
        ...
        log_hist_async(action="CREATION_JOUR_FERIE", table_name="jours_feries", record_id=new_id, description=f"Jour férié créé : {date_ferie} - {libelle}")
        return new_id
    ...
    def update(jour_id: int, date_ferie: str, libelle: str, fixe: bool) -> None:
        ...
        log_hist_async(action="MODIFICATION_JOUR_FERIE", table_name="jours_feries", record_id=jour_id, description=f"Jour férié #{jour_id} modifié : {date_ferie}")

    @staticmethod
    def delete(jour_id: int) -> tuple:
        QueryExecutor.execute_write("DELETE FROM jours_feries WHERE id=%s", (jour_id,))
        log_hist_async(action="SUPPRESSION_JOUR_FERIE", table_name="jours_feries", record_id=jour_id, description=f"Jour férié #{jour_id} supprimé")
...
class CompetencesCatalogueService:
    ...
    def create(code: str, libelle: str, description: str = None,
        ...
        log_hist_async(action="CREATION_COMPETENCE", table_name="competences_catalogue", record_id=new_id, description=f"Compétence créée : {code} - {libelle}")
        return new_id
    ...
    def update(comp_id: int, code: str, libelle: str, description: str,
        ...
        log_hist_async(action="MODIFICATION_COMPETENCE", table_name="competences_catalogue", record_id=comp_id, description=f"Compétence #{comp_id} modifiée : {code}")
    ...
    def delete(comp_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_COMPETENCE", table_name="competences_catalogue", record_id=comp_id, description=f"Compétence #{comp_id} supprimée")
...
class CategoriesDocsService:
    ...
    def create(nom: str, description: str = None, couleur: str = '#3b82f6',
        ...
        log_hist_async(action="CREATION_CATEGORIE_DOC", table_name="categories_documents", record_id=new_id, description=f"Catégorie document créée : {nom}")
        return new_id
    ...
    def update(cat_id: int, nom: str, description: str, couleur: str,
        ...
        log_hist_async(action="MODIFICATION_CATEGORIE_DOC", table_name="categories_documents", record_id=cat_id, description=f"Catégorie document #{cat_id} modifiée : {nom}")
    ...
    def delete(cat_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_CATEGORIE_DOC", table_name="categories_documents", record_id=cat_id, description=f"Catégorie document #{cat_id} supprimée")
...
class RefMotifSortieService:
    ...
    def create(libelle: str, actif: bool = True) -> int:
        ...
        log_hist_async(action="CREATION_MOTIF_SORTIE", table_name="ref_motif_sortie", record_id=new_id, description=f"Motif de sortie créé : {libelle}")
        return new_id
    ...
    def update(motif_id: int, libelle: str, actif: bool) -> None:
        ...
        log_hist_async(action="MODIFICATION_MOTIF_SORTIE", table_name="ref_motif_sortie", record_id=motif_id, description=f"Motif de sortie #{motif_id} modifié : {libelle}")
    ...
    def delete(motif_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_MOTIF_SORTIE", table_name="ref_motif_sortie", record_id=motif_id, description=f"Motif de sortie #{motif_id} supprimé")
...
class TranchesAgeService:
    ...
    def create(libelle: str, age_min: int, age_max: int = None) -> int:
        ...
        log_hist_async(action="CREATION_TRANCHE_AGE", table_name="tranche_age", record_id=new_id, description=f"Tranche d'âge créée : {libelle}")
        return new_id
    ...
    def update(tranche_id: int, libelle: str, age_min: int, age_max: int = None) -> None:
        ...
        log_hist_async(action="MODIFICATION_TRANCHE_AGE", table_name="tranche_age", record_id=tranche_id, description=f"Tranche d'âge #{tranche_id} modifiée : {libelle}")
    ...
    def delete(tranche_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_TRANCHE_AGE", table_name="tranche_age", record_id=tranche_id, description=f"Tranche d'âge #{tranche_id} supprimée")
...
class RolesConfigService:
    ...
    def create(nom: str, description: str = None) -> int:
        ...
        log_hist_async(action="CREATION_ROLE", table_name="roles", record_id=new_id, description=f"Rôle créé : {nom}")
        return new_id
    ...
    def update(role_id: int, nom: str, description: str = None) -> None:
        ...
        log_hist_async(action="MODIFICATION_ROLE", table_name="roles", record_id=role_id, description=f"Rôle #{role_id} modifié : {nom}")
    ...
    def delete(role_id: int) -> tuple:
        ...
        log_hist_async(action="SUPPRESSION_ROLE", table_name="roles", record_id=role_id, description=f"Rôle #{role_id} supprimé")
...
class SoldeCongesService:
    ...
    def create(personnel_id: int, annee: int, cp_acquis: float = 0.0,
        ...
        log_hist_async(action="CREATION_SOLDE_CONGES", table_name="solde_conges", record_id=new_id, description=f"Solde congés créé : personnel #{personnel_id} année {annee}")
        return new_id
    ...
    def update(solde_id: int, personnel_id: int, annee: int, cp_acquis: float,
        ...
        log_hist_async(action="MODIFICATION_SOLDE_CONGES", table_name="solde_conges", record_id=solde_id, description=f"Solde congés #{solde_id} modifié")

    @staticmethod
    def delete(solde_id: int) -> tuple:
        QueryExecutor.execute_write("DELETE FROM solde_conges WHERE id=%s", (solde_id,))
        log_hist_async(action="SUPPRESSION_SOLDE_CONGES", table_name="solde_conges", record_id=solde_id, description=f"Solde congés #{solde_id} supprimé")
...
class DocumentEventRulesService:
    ...
    def create(event_name: str, template_id: int = None, execution_mode: str = 'AUTO',
        ...
        log_hist_async(action="CREATION_DOC_EVENT_RULE", table_name="document_event_rules", record_id=new_id, description=f"Règle événement créée : {event_name}")
        return new_id
    ...
    def update(rule_id: int, event_name: str, template_id: int = None,
        ...
        log_hist_async(action="MODIFICATION_DOC_EVENT_RULE", table_name="document_event_rules", record_id=rule_id, description=f"Règle événement #{rule_id} modifiée : {event_name}")

    @staticmethod
    def delete(rule_id: int) -> tuple:
        QueryExecutor.execute_write("DELETE FROM document_event_rules WHERE id=%s", (rule_id,))
        log_hist_async(action="SUPPRESSION_DOC_EVENT_RULE", table_name="document_event_rules", record_id=rule_id, description=f"Règle événement #{rule_id} supprimée")
...
class DemandeAbsenceAdminService:
    ...
    def update_statut(demande_id: int, statut: str, commentaire: str = None) -> None:
        ...
        log_hist_async(action="MODIF_STATUT_DEMANDE_ABSENCE", table_name="demande_absence", record_id=demande_id, description=f"Demande absence #{demande_id} → {statut}")

    @staticmethod
    def delete(demande_id: int) -> tuple:
        QueryExecutor.execute_write("DELETE FROM demande_absence WHERE id=%s", (demande_id,))
        log_hist_async(action="SUPPRESSION_DEMANDE_ABSENCE", table_name="demande_absence", record_id=demande_id, description=f"Demande absence #{demande_id} supprimée")
...
class PolyvalenceAdminService:
    ...
    def update(polyvalence_id: int, niveau: int,
        ...
        log_hist_async(action="ADMIN_MODIF_POLYVALENCE", table_name="polyvalence", record_id=polyvalence_id, description=f"Polyvalence #{polyvalence_id} modifiée (admin)")

...
class ToastManager:
    ...
    Usage:
        ...
        ToastManager.warning("Contrat expire bientôt")
        ToastManager.info("Données chargées")
    """
...
class LoadingButton(QtWidgets.QPushButton):
    ...
    Usage:
        ...
        btn.set_loading(True)   # désactive + animation points
        btn.set_loading(False)  # restaure
    """

...
from gui.components.emac_ui_kit import add_custom_title_bar, show_error_message, EmacBadge
from gui.components.ui_theme import EmacButton
from gui.workers.db_worker import DbWorker, DbThreadPool
from gui.components.loading_components import EmptyStatePlaceholder
...
class GestionAlertesRHDialog(QDialog):
    ...
    def _on_view_personnel_detail(self, alert: Alert):
        ...
        if pid:
            try:
                from gui.screens.personnel.gestion_personnel import DetailOperateurDialog
